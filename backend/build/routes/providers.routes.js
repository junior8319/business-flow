...
const providerCreate_middleware_1 = __importDefault(require("../middlewares/providers/providerCreate.middleware"));
...
providersRouter.post('/providers', providerCreate_middleware_1.default, Providers_controller_1.default.createProvider, error_middleware_1.default.handleErrors);
